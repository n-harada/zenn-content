...
- **理解するために使う脳内メモリの消費量 = コードを理解するのに必要な情報量 - 読み手が使える予備知識**
- 「**そのコード 1 行を単独で理解するのに必要な、追加の情報を意識する。その追加で必要な情報が減るようなコードにする**」というのが可読性を高めるための一つの**大きなの指針**としてアリなのではないか。

注意) 本記事は、可読性という曖昧な概念を、コンテキストと脳内メモリという切り口で説明を試たものです。冗長な例もあるかと思いますが何卒ご容赦ください。
...
```
彼女って、彼とアレだから、ちょっと難しいかも
```

この一文だけ見て意味がわかる人はいないんじゃないでしょうか。

私が用意した正解は下記です。

```
彼女(花子)って、彼(友人の太郎)とアレ(喧嘩している最中)だから、ちょっと難しいかも(一緒に野球観戦に行くのは無理です)
```

…絶対わからないですね。

まず「彼女」が花子かどうかこの文だけで分かるわけないし、「彼」は恋人を指すかもしれないです。
「アレ」は、別れたことを指しているかもしれないし、「ちょっと難しい」は本当にちょっと難しいだけかもしれないですね。野球観戦なんて言葉は微塵も出てきていないです。

もちろん文章を遡ったり、この文章の言葉の国の文化を知っていれば、適切に解釈できるでしょうが、かなり労力のいる作業になりますね。つまりこの文章は、**予備知識や文化的な価値観が前提**にあり、(広い意味で)**ハイコンテキスト**な文章になっているのです。
...
(注意)もちろん、本当に「その 1 行だけ」を見てその行を理解できる必要があるか、といえばそうではないと思います。それを目指し過ぎて冗長な表現になり、かえって可読性やパフォーマンスが落ちる可能性があります。指針はあくまで指針なので、**その他の基準とのバランス**を取って欲しいと思います。
