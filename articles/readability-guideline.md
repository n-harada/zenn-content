...
「その 1 行だけ」を見て理解できるかどうかと言いましたが、実際にはそのスコープの処理内容や、前後の行の情報は脳内に持っているかと思います。したがって、is_male と言えば、あー sex 変数のことだなとわかります。しかし、それを言い出すとなし崩し的に指針の意味がなくなるので、「その 1 行だけ読んだ時に」としています。
