...
自分のコードってある程度読みやすいですよね。それは、**コードの処理内容**や、**自分のコードの癖**を事前に知っているからです。これが、コードについての予備知識です。
...
記事の最初の方で、予備知識にはコードの癖や、コーディング規約も含まれると言いました。従って、例えば**チームに合った規約を増やす**ことで、脳内メモリの消費を減らすことができるのです。例えば、チームのコード規約に、「メモ化された計算結果には〜Memo と変数の最後につける」みたいなのを加えるだけでも、コードから得られる情報量は増えます。これも予備知識の活用と言えるでしょう。もちろん、増やし過ぎた規約や直感的でないものは逆効果になり得るので注意です。
