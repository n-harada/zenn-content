---
title: '可読性を高める2つの方法 - 脳内メモリに優しいコードを書く指針 -'
emoji: '📖'
...
:::message
この「予備知識」もコンテキストと言うことができると思います。そう考えると、可読性を高める指針は、**読み手の知らないコンテキストを減らし、知っているコンテキストを増やす**とも言い換えられるでしょう。ただ、コード内のコンテキストと、コード外の一つメタ的なコンテキストで毛色が若干違うものなので逆に混乱を来たすかと思い、この切り口での説明は諦めました。
:::
