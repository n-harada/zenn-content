...
:::message
この「予備知識」もコンテキストと言うことができると思います。そう考えると、可読性を高める指針は、**読み手の知らないコンテキストを減らし、知っているコンテキストを増やす**とも言い換えられるでしょう。ただ、コード内のコンテキストと、コード外の一つメタ的なコンテキストで毛色が若干違うものなのでわかりづらいかと思い、この切り口での説明は諦めました。
:::
